...
func (r *Resolver) Visibility(met map[string]string) (string, error) {
	...
	return use.Obj.Metadata[metadata.ResourceVisibility], nil
}

func user(met map[string]string) map[string]string {
	...
	cop[metadata.ResourceKind] = "user"
